...
class Magneto_Debug_Model_Metrics extends Mage_Core_Model_Abstract
{
    ...
    public function getLevel($value){
        ...
        //Pour être sûr d'avoir toutes les valeurs positives à 4 écart type sous la moyenne, c'est un offset
        ...
        //On parcourt les principaux écarts type autour de la moyenne
